...
20thcentury_lyrics = "Friends say it's fine, friends say it's good,
...
s14 = Song.create!(name: 'Planet Queen', source_url: 'placeholder.url', release_id: r1.id)
...
s17 = Song.create!(name: '20th Century Boy', lyrics: 20thcentury_lyrics, source_url: 'placeholder.url', release_id: r2.id)
s18 = Song.create!(name: 'Solid Gold Easy Action', source_url: 'placeholder.url', release_id: r3.id)